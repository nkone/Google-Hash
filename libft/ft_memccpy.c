...
/*   Updated: 2019/02/25 09:33:50 by phtruong         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** PSEUDOCODE
** Initialize pointer and point them to dst and src
** While n is true
** Copy src to dest
** Check if the copy is the same as character c
** If so return pointer to dst.
*/
